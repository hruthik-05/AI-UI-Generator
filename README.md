...
1.  **Frontend (`src/components/Chatpanel.jsx`)**:
    Change all instances of `https://ai-ui-generator-seven.vercel.app/` to `http://localhost:5000`.

2.  **Backend (`server/app.js`)**:
    Update the CORS origin `https://ai-ui-generator-4nfj.onrender.com/` to include your local frontend URL (e.g., `http://localhost:5173`).
